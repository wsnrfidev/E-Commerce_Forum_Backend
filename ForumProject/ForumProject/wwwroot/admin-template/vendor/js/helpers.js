    ...
    return function() {
                ...
                if (null != n) {
                    ...
                    try {
                        if (r = (n = n.call(e)).next, 0 === t) {
                            ...
                            for (; !(l = (i = r.call(n)).done) && (s.push(i.value), s.length !== t); l = !0);
                    } catch (e) {
                        u = !0, o = e
                    } finally {
                        try {
        ...
        var d = {
            ...
            _unbindLayoutAnimationEndEvent: function() {
                var e = this,
                    t = this.getMenu();
                this._transitionCallbackTimeout && (clearTimeout(this._transitionCallbackTimeout), this._transitionCallbackTimeout = null), t && this._transitionCallback && l.forEach((function(n) {
            ...
            setContentLayout: function() {
                ...
                setTimeout((function() {
                    var n, i = document.querySelector(".content-wrapper > div"),
                        ...
                        f = !1;
                    document.querySelector(".content-wrapper > .menu-horizontal > div") && (f = !0, n = document.querySelector(".content-wrapper > .menu-horizontal > div")), "compact" === t ? (u.some((function(e) {
                        return [i, l].includes(e)
                    })) && (e._removeClass("container-fluid", [i, l]), e._addClass("container-xxl", [i, l])), s && (e._removeClass("container-fluid", [s]), e._addClass("container-xxl", [s])), d && u.some((function(e) {
                        return [o].includes(e)
                    })) && (e._removeClass("container-fluid", [o]), e._addClass("container-xxl", [o])), f && (e._removeClass("container-fluid", n), e._addClass("container-xxl", n), r && (e._removeClass("container-fluid", r), e._addClass("container-xxl", r)), a && (e._removeClass("container-fluid", a), e._addClass("container-xxl", a)))) : (c.some((function(e) {
                        return [i, l].includes(e)
                    })) && (e._removeClass("container-xxl", [i, l]), e._addClass("container-fluid", [i, l])), s && (e._removeClass("container-xxl", [s]), e._addClass("container-fluid", [s])), d && c.some((function(e) {
                        return [o].includes(e)
                    })) && (e._removeClass("container-xxl", [o]), e._addClass("container-fluid", [o])), f && (e._removeClass("container-xxl", n), e._addClass("container-fluid", n), r && (e._removeClass("container-xxl", r), e._addClass("container-fluid", r)), a && (e._removeClass("container-xxl", a), e._addClass("container-fluid", a))))
                }), 100)
            },
            update: function() {
            ...
            initPasswordToggle: function() {
                ...
                null != e && e.forEach((function(e) {
                    e.addEventListener("click", (function(t) {
                        ...
                        "text" === o.getAttribute("type") ? (o.setAttribute("type", "password"), i.classList.replace("mdi-eye-outline", "mdi-eye-off-outline")) : "password" === o.getAttribute("type") && (o.setAttribute("type", "text"), i.classList.replace("mdi-eye-off-outline", "mdi-eye-outline"))
                    }))
                }))
            },
                    ...
                    document.querySelectorAll(".nav-tabs").forEach((function(e) {
                        ...
                        var i = e.closest(".nav-align-left") || e.closest(".nav-align-right"),
                            o = function(n) {
                                ...
                                i ? (t.style.top = r.y - o.y + "px", t.style[e.closest(".nav-align-right") ? "inset-inline-start" : "inset-inline-end"] = 0, t.style.height = r.height + "px") : (t.style.left = a + "px", t.style.width = r.width + "px", s || (t.style.bottom = 0))
                            };
                ...
                document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach((function(e) {
                    e.addEventListener("click", (function() {
                        ...
                        document.querySelectorAll(t).forEach((function(e) {
                            e.classList.toggle("show"), null != n && !1 !== n && void 0 !== i && (e.classList.contains("show") ? i[0].classList.add("show") : i[0].classList.remove("show"), i[0].addEventListener("click", (function(t) {
