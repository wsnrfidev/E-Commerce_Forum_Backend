                ...
                translate(t, e, n) {
                    ...
                    if (y && p && "string" != typeof p && "boolean" != typeof p && "number" != typeof p && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
                        if (!e.returnObjects && !this.options.returnObjects) {
                            ...
                            const t = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, p, { ...e,
                                ns: s
            ...
            class C {
                ...
                interpolate(t, e, n, o) {
                    ...
                    const c = t => {
                        if (t.indexOf(this.formatSeparator) < 0) {
                            ...
                            return this.alwaysFormat ? this.format(i, void 0, n, { ...o,
                                ...e,
                                interpolationkey: t
                            }) : i
                        }
                        ...
                        return this.format(N(e, l, r, this.options.keySeparator, this.options.ignoreJSONStructure), s, n, { ...o,
                            ...e,
                            interpolationkey: r
                        })
                    };
                ...
                nest(t, e) {
                    ...
                    for (; n = this.nestingRegexp.exec(t);) {
                        ...
                        "string" != typeof o && (o = a(o)), o || (this.logger.warn(`missed to resolve ${n[1]} for nesting ${t}`), o = ""), u && (o = l.reduce(((t, e) => this.format(t, e, r.lng, { ...r,
            ...
            class $ {
                constructor() {
                    ...
                    this.logger = n.create("formatter"), this.options = t, this.formats = {
                        number: T(((t, e) => {
                            const n = new Intl.NumberFormat(t, { ...e
                            });
                            return t => n.format(t)
                        })),
                        currency: T(((t, e) => {
                        ...
                        datetime: T(((t, e) => {
                            const n = new Intl.DateTimeFormat(t, { ...e
                            });
                            return t => n.format(t)
                        })),
                        relativetime: T(((t, e) => {
                            const n = new Intl.RelativeTimeFormat(t, { ...e
                            });
                            return t => n.format(t, e.range || "day")
                        })),
                        list: T(((t, e) => {
                            const n = new Intl.ListFormat(t, { ...e
                            });
                            return t => n.format(t)
                        }))
                    }, this.init(t)
