    ...
    return function() {
        var e = {
                1936: function() {
                    ! function(e) {
                        ...
                        function S(e) {
                            return (e = e.toString()) && e.replace(x, E).replace($, "")
                        }
                        var C, O, A, T, z, D = (C = {
                                "&": "&amp;",
                                "<": "&lt;",
                        ...
                        K.VERSION = "1.14.0-beta3", K.DEFAULTS = {
                                ...
                                function h(e, i) {
                                    ...
                                    if (void 0 === c && (c = 0), d = [n.selectpicker.view.position0, n.selectpicker.view.position1], l = Math.max(0, c - 1), a = Math.min(o - 1, c + 1), n.selectpicker.view.position0 = !1 === w ? 0 : Math.max(0, g[l][0]) || 0, n.selectpicker.view.position1 = !1 === w ? v : Math.min(v, g[a][1]) || 0, p = d[0] !== n.selectpicker.view.position0 || d[1] !== n.selectpicker.view.position1, void 0 !== n.activeElement && (i && (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement), n.activeElement = void 0), n.activeElement !== n.selectedElement && n.defocusItem(n.selectedElement)), void 0 !== n.prevActiveElement && n.prevActiveElement !== n.activeElement && n.prevActiveElement !== n.selectedElement && n.defocusItem(n.prevActiveElement), i || p || n.selectpicker.current.hasMore) {
                                        if (u = n.selectpicker.view.visibleElements ? n.selectpicker.view.visibleElements.slice() : [], n.selectpicker.view.visibleElements = !1 === w ? n.selectpicker.current.elements : n.selectpicker.current.elements.slice(n.selectpicker.view.position0, n.selectpicker.view.position1), n.setOptionStatus(), (t || !1 === w && i) && (f = u, m = n.selectpicker.view.visibleElements, b = !(f.length === m.length && f.every((function(e, t) {
                                            ...
                                            var y, x, $ = n.$menuInner[0],
                                                E = document.createDocumentFragment(),
                                                S = $.firstChild.cloneNode(!1),
                                                C = n.selectpicker.view.visibleElements,
                                                O = [];
                                            $.replaceChild(S, $.firstChild), k = 0;
                                            for (var A = C.length; k < A; k++) {
                                                var T, z, D = C[k];
                                                n.options.sanitize && (T = D.lastChild) && (z = n.selectpicker.current.data[k + n.selectpicker.view.position0]) && z.content && !z.sanitized && (O.push(T), z.sanitized = !0), E.appendChild(D)
                                            }
                                            if (n.options.sanitize && O.length && r(O, n.options.whiteList, n.options.sanitizeFn), !0 === w ? (y = 0 === n.selectpicker.view.position0 ? 0 : n.selectpicker.current.data[n.selectpicker.view.position0 - 1].position, x = n.selectpicker.view.position1 > v - 1 ? 0 : n.selectpicker.current.data[v - 1].position - n.selectpicker.current.data[n.selectpicker.view.position1 - 1].position, $.firstChild.style.marginTop = y + "px", $.firstChild.style.marginBottom = x + "px") : ($.firstChild.style.marginTop = 0, $.firstChild.style.marginBottom = 0), $.firstChild.appendChild(E), !0 === w && n.sizeInfo.hasScrollBar) {
                                                var L = $.firstChild.offsetWidth;
                                                if (i && L < n.sizeInfo.menuInnerInnerWidth && n.sizeInfo.totalMenuWidth > n.sizeInfo.selectWidth) $.firstChild.style.minWidth = n.sizeInfo.menuInnerInnerWidth + "px";
                                                else if (L > n.sizeInfo.menuInnerInnerWidth) {
                                                    n.$menu[0].style.minWidth = 0;
                                                    var N = $.firstChild.offsetWidth;
                                                    N > n.sizeInfo.menuInnerInnerWidth && (n.sizeInfo.menuInnerInnerWidth = N, $.firstChild.style.minWidth = n.sizeInfo.menuInnerInnerWidth + "px"), n.$menu[0].style.minWidth = ""
                                                }
                                            }
                                        }
                            ...
                            render: function(e) {
                                ...
                                if (u.childNodes.length || (u = _.text.call(this, {
                                    ...
                                    var x = d.querySelector(".filter-expand"),
                                        $ = h.cloneNode(!0);
                                    $.className = "filter-expand", x ? d.replaceChild($, x) : d.appendChild($)
                                }
                            ...
                            liHeight: function(t) {
                                if (t || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                                    ...
                                    o.style.overflowY = "scroll", w = n.offsetWidth - A, document.body.removeChild(s), this.sizeInfo.liHeight = k, this.sizeInfo.dropdownHeaderHeight = y, this.sizeInfo.headerHeight = x, this.sizeInfo.searchHeight = $, this.sizeInfo.actionsHeight = E, this.sizeInfo.doneButtonHeight = S, this.sizeInfo.dividerHeight = C, this.sizeInfo.menuPadding = T, this.sizeInfo.menuExtras = z, this.sizeInfo.menuWidth = A, this.sizeInfo.menuInnerInnerWidth = A - T.horiz, this.sizeInfo.totalMenuWidth = this.sizeInfo.menuWidth, this.sizeInfo.scrollBarWidth = w, this.sizeInfo.selectHeight = this.$newElement[0].offsetHeight, this.setPositionData()
                                }
                            },
                                ...
                                i.data("spaceSelect", !1), this.$button.on("keyup", (function(e) {
                                    ...
                                    if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(B.DISABLED)) {
                                        var f = r.option,
                                            ...
                                            x = I && I.children,
                                            $ = parseInt(t.options.maxOptions),
                                            E = I && parseInt(y(I, "maxOptions")) || !1;
                                        if (a === t.activeElement && (s = !0), s || (t.prevActiveElement = t.activeElement, t.activeElement = void 0), t.multiple && 1 !== $) {
                                            if (t.setSelected(r, !w), t.focusedParent.focus(), !1 !== $ || !1 !== E) {
                                                var S = $ < m.call(t).length,
                                                    C = 0;
                                                if (I && I.children)
                                                    for (var O = 0; O < I.children.length; O++) I.children[O].selected && C++;
                                                var A = E < C;
                                                if ($ && S || E && A)
                                                    if ($ && 1 === $) o.selectedIndex = -1, t.setOptionStatus(!0);
                                                    else if (E && 1 === E) {
                                                    ...
                                                    D[2] && (L = L.replace("{var}", D[2][$ > 1 ? 0 : 1]), N = N.replace("{var}", D[2][E > 1 ? 0 : 1])), t.$menu.append(H), $ && S && (H.append(e("<div>" + L + "</div>")), u = !1, t.$element.trigger("maxReached" + W)), E && A && (H.append(e("<div>" + N + "</div>")), u = !1, t.$element.trigger("maxReachedGrp" + W)), setTimeout((function() {
                                                        t.setSelected(r, !1)
        ...
        return function() {
            ...
            i.r(s), i.d(s, {
                ...
                handleBootstrapSelectEvents: function() {
                    return n
                }
            });
            var e = i(1936),
            ...
            function n() {
                $(".form-floating:has(.selectpicker)").each((function() {
                    $(this).addClass("form-floating-bootstrap-select"), $(this).on("show.bs.select", (function() {
