                        ...
                        function re(e) {
                            ...
                            if (u) {
                                var W = E(r),
                                    B = "clientHeight",
                                    H = "clientWidth";
                                W === t(r) && "static" !== h(W = d(r)).position && "absolute" === c && (B = "scrollHeight", H = "scrollWidth"), (i === D || (i === M || i === P) && a === S) && (L = A, b -= (m && W === k && k.visualViewport ? k.visualViewport.height : W[B]) - o.height, b *= p ? 1 : -1), i !== M && (i !== D && i !== A || a !== S) || (j = P, y -= (m && W === k && k.visualViewport ? k.visualViewport.width : W[H]) - o.width, y *= p ? 1 : -1)
                            }
                                        ...
                                        a = R.reduce((function(e, n) {
                                            return e[n] = function(e, t, n) {
                                                var r = F(e),
                                                    ...
                                                    a = i[0],
                                                    s = i[1];
                                                return a = a || 0, s = (s || 0) * o, [M, P].indexOf(r) >= 0 ? {
                                                    x: s,
                                                    y: a
                                                } : {
                                                    x: a,
                            ...
                            fn: function(e) {
                                ...
                                if (!t.modifiersData[r]._skip) {
                                    for (var o = n.mainAxis, i = void 0 === o || o, a = n.altAxis, s = void 0 === a || a, f = n.fallbackPlacements, c = n.padding, p = n.boundary, u = n.rootBoundary, l = n.altBoundary, d = n.flipVariations, m = void 0 === d || d, h = n.allowedAutoPlacements, v = t.options.placement, y = F(v), g = f || (y !== v && m ? function(e) {
                                        ...
                                        var C = fe(q),
                                            _ = [];
                                        if (i && _.push(V[B] <= 0), s && _.push(V[q] <= 0, V[C] <= 0), _.every((function(e) {
                                                return e
                                            }))) {
                                            E = S, j = !1;
                                            break
                                    ...
                                    if (k) {
                                        if (s) {
                                            var q, C = "y" === j ? D : M,
                                                ...
                                                ne = ee[_],
                                                re = de(0, S[N], $[N]),
                                                oe = O ? S[N] / 2 - G - re - te - T.mainAxis : K - re - te - T.mainAxis,
                                                ie = O ? -S[N] / 2 + G + re + ne + T.mainAxis : Q + re + ne + T.mainAxis,
                                                ae = t.elements.arrow && E(t.elements.arrow),
                                                se = ae ? "y" === j ? ae.clientTop || 0 : ae.clientLeft || 0 : 0,
                                                fe = null != (q = null == R ? void 0 : R[j]) ? q : 0,
                                                ce = I + ie - fe,
                                                pe = de(h ? a(X, I + oe - fe - se) : X, I, h ? i(Y, ce) : Y);
                                            k[j] = pe, V[j] = pe - I
                                        }
                                        if (c) {
                                            var ue, le = "x" === j ? D : M,
