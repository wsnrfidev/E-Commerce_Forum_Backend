/*! For license information please see typeahead.js.LICENSE.txt */ ! function(t, e) {
                        ...
                        return s.Bloodhound = (e = t, n = function() {
                            ...
                            return u.setMaxPendingRequests = function(t) {
                                ...
                                _get: function(e, n) {
                                    ...
                                    s = this._fingerprint(e), this.cancelled || s !== this.lastReq || ((o = i[s]) ? o.done(a).fail(c) : t < r ? (t++, i[s] = this._send(e).done(a).fail(c).always((function() {
                            ...
                            return n.mixin(i.prototype, {
                                ...
                                add: function(e) {
                                    ...
                                    e = n.isArray(e) ? e : [e], n.each(e, (function(e) {
                                        var o, u;
                                        i.datums[o = i.identify(e)] = e, u = r(i.datumTokenizer(e)), n.each(u, (function(e) {
                                            var n, r, u;
                                            for (n = i.trie, r = e.split(""); u = r.shift();)(n = n[t][u] || (n[t][u] = s())).i.push(o)
                                        }))
                                    }))
                                },
                                get: function(t) {
                                ...
                                search: function(e) {
                                    var i, s, o = this;
                                    return i = r(this.queryTokenizer(e)), n.each(i, (function(e) {
                                        var n, i, r, u;
                                        if (s && 0 === s.length) return !1;
                                        for (n = o.trie, i = e.split(""); n && (r = i.shift());) n = n[t][r];
                                        if (!n || 0 !== i.length) return s = [], !1;
                                        u = n.i.slice(0), s = s ? function(t, e) {
                                            var n = 0,
                                                i = 0,
                                                r = [];
                                            t = t.sort(), e = e.sort();
                            ...
                            return n.mixin(t.prototype, {
                                ...
                                get: function(t, e) {
                                    var n, i = this;
                                    if (e) return t = t || "", n = this.prepare(t, this._settings()), this.transport.get(n, (function(t, n) {
                                        e(t ? [] : i.transform(n))
                                    }))
                                },
                        ...
                        return e = t, n = function() {
                            ...
                            return {
                                ...
                                trigger: function(n) {
                                    ...
                                    for (n = n.split(t), o = [].slice.call(arguments, 1);
                                        (r = n.shift()) && (s = this._callbacks[r]);) u = i(s.sync, this, [r].concat(o)), a = i(s.async, this, [r].concat(o)), u() && e(a);
                                    return this
                                }
                            };
                            ...
                            function n(e, n, i, r) {
                                ...
                                for (n = n.split(t), i = r ? function(t, e) {
                                    ...
                                    }(i, r) : i, this._callbacks = this._callbacks || {}; s = n.shift();) this._callbacks[s] = this._callbacks[s] || {
                                    sync: [],
                                    async: []
                            ...
                            function i(t, i) {
                                var r;
                                (t = t || {}).input || e.error("input is missing"), i.mixin(this), this.$hint = e(t.hint), this.$input = e(t.input), this.query = this.$input.val(), this.queryWhenFocused = this.hasFocus() ? this.query : null, this.$overflowHelper = (r = this.$input, e('<pre aria-hidden="true"></pre>').css({
                                    position: "absolute",
                                    visibility: "hidden",
                                    whiteSpace: "pre",
                                ...
                                }).insertAfter(r)), this._checkLanguageDirection(), 0 === this.$hint.length && (this.setHint = this.getHint = this.clearHint = this.clearHintIfInvalid = n.noop)
                            }
                            return t = {
                                9: "tab",
                                27: "esc",
                            ...
                            function r(t, r) {
                                ...
                                }(t.display || t.displayKey), this.templates = function(t, i) {
                                    return {
                                ...
                                }(t.templates, this.displayFn), this.source = t.source.__ttAdapter ? t.source.__ttAdapter() : t.source, this.async = n.isUndefined(t.async) ? this.source.length > 2 : !!t.async, this._resetLastSuggestion(), this.$el = e(t.node).addClass(this.classes.dataset).addClass(this.classes.dataset + "-" + this.name)
                            }
                            return t = {
                            ...
                            function t(t, i) {
                                var r = this;
                                (t = t || {}).node || e.error("node is required"), i.mixin(this), this.$node = e(t.node), this.query = null, this.datasets = n.map(t.datasets, (function(t) {
                            ...
                            return n.mixin(t.prototype, s, {
                                ...
                                destroy: function() {
                                    this.$node.off(".tt"), this.$node = e("<div>"), n.each(this.datasets, (function(t) {
                                        t.destroy()
                                    }))
                                }
                            }), t
                        ...
                        function() {
                            ...
                            t = e.fn.typeahead, s = {
                                ...
                                initialize: function(t, o) {
                                    var a;
                                    return o = n.isArray(o) ? o : [].slice.call(arguments, 1), a = i((t = t || {}).classNames), this.each((function() {
                                        var i, d, p, g, m, y, v, _, b, w, S;
                                        n.each(o, (function(e) {
                                            e.highlight = !!t.highlight
                                        })), i = e(this), d = e(a.html.wrapper), p = f(t.hint), g = f(t.menu), m = !1 !== t.hint && !p, y = !1 !== t.menu && !g, m && (p = function(t, e) {
                                            ...
                                            var n
                                        }(i, a)), y && (g = e(a.html.menu).css(a.css.menu)), p && p.val(""), i = function(t, e) {
                                            t.data(s.attrs, {
                                                dir: t.attr("dir"),
                                            ...
                                            return t
                                        }(i, a), (m || y) && (d.css(a.css.wrapper), i.css(m ? a.css.input : a.css.inputWithNoHint), i.wrap(d).parent().prepend(m ? p : null).append(y ? g : null)), S = y ? h : c, v = new r({
                                            el: i
                                        }), _ = new u({
                                            hint: p,
                                            input: i
                                        ...
                                        }, a), i.data(s.www, a), i.data(s.typeahead, w)
                                    }))
                                },
                                isEnabled: function() {
                                    var t;
